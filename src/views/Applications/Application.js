...
const dat = {
  ...
  rows: [
    {
      project: <Link href = '/dashboard'>Tiger Nixon</Link>,
          ...
          <Container  sx={{ mt: 2, mb: 4 }}>
            <Grid container spacing={3}>
              <Grid item xs ={12} sm ={3} md={3} lg={3}>
                ...
                >
                  <Typography sx = {{fontSize: 15}}><b><u>Project Alpha</u></b></Typography>
                  <Typography sx = {{fontSize: 15}}>Created By: John Doe</Typography>
                  <Typography sx = {{fontSize: 15}}>Date Created: June 08 2022</Typography>
                  <Box sx={{
                    display: 'flex',
                  }}>
                    <Typography sx = {{fontSize: 15, }}>Status: Active</Typography>
                    <Button
                      style={{textTransform: 'none', height: 20, marginTop: 3, marginLeft: 8, outline: 'none'}}
              ...
              <Grid item xs ={12} sm ={3} md={3} lg={5}>
                ...
                >
                  ...
                  <Typography sx = {{textAlign: "center", fontSize: 15}}>Activity</Typography>
                </Paper>
              </Grid>
            </Grid>
