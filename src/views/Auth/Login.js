          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <FormControl sx={{ mt: 1, mb: 1, width: '100%' }} variant="outlined">
                <InputLabel sx={{mb: 1}} htmlFor="outlined-adornment-password">Password *</InputLabel>
                <OutlinedInput
                    required
