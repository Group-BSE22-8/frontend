            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs ={12} sm ={2} md={2} lg={2}>
                ...
                >
                  ...
                  <Typography sx = {{fontSize: 30}}>78</Typography>
                </Paper>
              </Grid>
              ...
              <Grid item xs ={12} sm ={2} md={2} lg={2}>
                ...
                >
                  <Typography sx = {{fontSize: 20}}>Users</Typography>
                  <Typography sx = {{fontSize: 30}}>85</Typography>
                </Paper>
              </Grid>
              ...
              <Grid item xs ={12} sm ={2} md={2} lg={2}>
                ...
                >
                  <Typography sx = {{fontSize: 20}}>Resources</Typography>
                  <Typography sx = {{fontSize: 30}}>23</Typography>
                </Paper>
              </Grid>
              <Grid item xs ={1} sm ={1} md={1} lg={1}>
              </Grid>
            ...
            <Card sx={{marginTop: 3}}>
              <Box 
                sx ={{
                 ...
                 <Typography sx = {{fontSize: 17}}>System status</Typography>
              </Box>
              <CardContent>
                <Grid container spacing={3}>
            ...
            <Card sx={{marginTop: 3}}>
              <Box 
                sx ={{
                 ...
                 <Typography sx = {{fontSize: 17}}>Recent Activity</Typography>
              </Box>
              <CardContent>
                <MDBDataTable
                  striped
